...
public enum ZipUtilConstants {
	FILE_NOT_FOUND_ERROR_CODE("CORE-UTL-401", "File Not Found"),
	IO_ERROR_CODE("CORE-UTL-402", "Interrupted IO Operation"),
	NULL_POINTER_ERROR_CODE("CORE-UTL-403", "Null Reference found"),
	DATA_FORMATE_ERROR_CODE("CORE-UTL-404", "Attempting to unzip file that is not zipped");
