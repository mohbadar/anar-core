...
public enum DateUtilConstants {
	...
	ILLEGALARGUMENT_ERROR_CODE("CORE-UTL-101", "Invalid Argument Found"),
	NULL_ARGUMENT_ERROR_CODE("CORE-UTL-102", "Null Argument Found"),
	PARSE_EXCEPTION_ERROR_CODE("CORE-UTL-103", "Parsing error occours");
