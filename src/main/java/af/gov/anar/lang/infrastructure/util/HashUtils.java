...
import af.gov.anar.lang.infrastructure.util.constant.HashUtilConstants;
import af.gov.anar.lang.infrastructure.util.exception.HashUtilException;
	...
	public HashUtils(final long initialOddNumber, final long multiplierOddNumber) throws HashUtilException {
		if (initialOddNumber % 2 == 0) {
			throw new HashUtilException(
					...
					HashUtilConstants.ANAR_ILLEGAL_ARGUMENT_INITIALODDNUMBER_ERROR_CODE.getErrorMessage());
		} else if (multiplierOddNumber % 2 == 0) {
			throw new HashUtilException(
					HashUtilConstants.ANAR_ILLEGAL_ARGUMENT_MULTIPLIERODDNUMBER_ERROR_CODE.getErrorCode(),
					HashUtilConstants.ANAR_ILLEGAL_ARGUMENT_MULTIPLIERODDNUMBER_ERROR_CODE.getErrorMessage());
		} else {
