...
import af.gov.anar.lang.infrastructure.util.constant.StringUtilConstants;
...
public final class StringUtils {
	 ...
	 * 
	 * @param sourceString1 String value
	 * @param sourceString2 String value
	 ...
	 * 
	 * @param sourceString1 String to compare from
	 * @param sourceString2 String to compare to
	 ...
	 * 
	 * @param sourceString the CharSequence to check, may be null
	 ...
	 * 
	 * @param charSeq the CharSequence to check, may be null
	 ...
	 * 
	 * @param sourceString the String to be trimmed, may be null
	 ...
	 * Truncates a String
	 * 
	 * @param sourceString the String to truncate, may be null
	 ...
	 * Truncates a String
	 * 
	 * @param sourceString the String to check, may be null
	 ...
	 * 
	 * @param sourceString the String to remove whitespace from, may be null
	 ...
	 * 
	 * @param sourceString the String to remove characters from, may be null
	 ...
	 * 
	 * @param charSeq1 the first CharSequence, may be null
	 * @param charSeq2 charSeq2 the second CharSequence, may be null
	 ...
	 * 
	 * @param sourceString1 the first CharSequence, may be null
	 * @param sourceString2 the second CharSequence, may be null
	 ...
	 * 
	 * @param sourceString the String to get the substring from, may be null
	 * @param start        the position to start from, negative means count back
	 ...
	 * @param start        the position to start from, negative means count back
	 *                     from the end of the String by this many characters
	 * @param end          the position to end at (exclusive), negative means count
	 ...
	 * 
	 * @param sourceString the String to get the leftmost characters from, may be
	 *                     null
	 ...
	 * 
	 * @param sourceString the String to get the rightmost characters from, may be
	 *                     null
	 * @param len          the length of the required String
	 ...
	 * 
	 * @param sourceString the String to get the characters from, may be null
	 * @param pos          the position to start from, negative treated as zero
	 * @param len          len the length of the required String
	 ...
	 * 
	 * @param sourceString the String to get a substring from, may be null
	 ...
	 * 
	 * @param sourceString String to parse, may be null
	 ...
	 * 
	 * @param sourceString  the String to parse, may be null
	 ...
	 * 
	 * @param sourceString the String to split, may be null
	 * @return an array of parsed Strings, null if null String input
	 */
	 ...
	 * @return the joined String, null if null array input
	 * @throws ArrayIndexOutOfBoundsException - if startIndex and endIndex are not
	 *                                        valid positions
	 */
	public static String join(Object[] array, char separator, int startIndex, int endIndex) {
		try {
			...
			throw new ArrayIndexOutOfBoundsException(
					StringUtilConstants.ANAR_ARRAY_INDEX_OUT_OF_BOUNDS_ERROR_CODE.getErrorCode(),
					StringUtilConstants.ANAR_ARRAY_INDEX_OUT_OF_BOUNDS_ERROR_CODE.getErrorMessage(), e.getCause());
		}
	}
	 ...
	 *
	 * @param sourceString the String to delete whitespace from, may be null
	 ...
	 *
	 * @param sourceString the source String to search, may be null
	...
	public static String removeAll(String text, String regex) {
		try {
			...
			throw new PatternSyntaxException(StringUtilConstants.ANAR_PATTERN_SYNTAX_ERROR_CODE.getErrorCode(),
					StringUtilConstants.ANAR_PATTERN_SYNTAX_ERROR_CODE.getErrorMessage(), e.getCause());
		}
	}
	 ...
	 *
	 * @param sourceString String to replace characters in, may be null
	 ...
	 *
	 * @param sourceString the String to do overlaying in, may be null
	 ...
	 * alone
	 *
	 * @param sourceString the String to chomp a newline from, may be null
	 ...
	 *
	 * @param sourceString the String to chop last character from, may be null
	 ...
	 *
	 * @param sourceString the String to repeat, may be null
	 * @param repeat       number of times to repeat sourceString, negative treated
	 *                     as zero
	 ...
	 *
	 * @param charSeq a CharSequence or null
	 ...
	 *
	 * @param sourceString the String to upper case, may be null
	 ...
	 * CharSequence length or 0 if the CharSequence is null
	 *
	 * @param sourceString the String to lower case, may be null
	 ...
	 *
	 * @param sourceString the String to local case, may be null
	 * @param locale       the locale that defines the case transformation rules,
	 *                     must not be null
	 ...
	 *
	 * @param sourceString the String to uncapitalize, may be null
	 ...
	 *
	 * @param sourceString the String to swap case, may be null
	 ...
	 *
	 * @param charSeq charSeq the CharSequence to check, may be null
	 ...
	 *
	 * @param sourceString the String to extract digits from, may be null
	 ...
	 *
	 * @param sourceString the String to rotate, may be null
	 ...
	 * Reverses a String
	 *
	 * @param sourceString the String to reverse, may be null
	...
	public static String abbreviate(String sourceString, int maxWidth) {
		try {
			...
			throw new IllegalArgumentException(StringUtilConstants.ANAR_ILLEGAL_ARGUMENT_ERROR_CODE.getErrorCode(),
					StringUtilConstants.ANAR_ILLEGAL_ARGUMENT_ERROR_CODE.getErrorMessage(), e.getCause());
		}
	}
	 ...
	 * 
	 * @param sourceString1 the first String, may be null
	 * @param sourceString2 the second String, may be null
	 ...
	 * 
	 * @param sourceString the source String to normalize whitespaces from, may be
	 *                     null
	 ...
	 * 
	 * @param sourceString The string
	 * @param prefix       The prefix to append to the end of the string
	 ...
	 * 
	 * @param sourceString the string to be wrapped, may be null
	 * @param wrapWith     the char that will wrap sourceString
	 ...
	 * 
	 * @param sourceString the String to be wrapper, may be null
	 * @param wrapWith     the String that will wrap sourceString
	 ...
	 * 
	 * @param sourceString the String to be unwrapped, can be null
